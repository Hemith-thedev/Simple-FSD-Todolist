          ...
          <UL
            ...
            contents={[
              ...
              <CodeDisplay label="JavaScript JSX" Code={
                <>
                <span><br /></span>
                  <span className="comment">// MySQL Pool Configuration<br /></span>
                  <span><span className="midblue">const</span> <span className="blue">database</span> = <span className="lightblue">mysql</span>.<span className="lightyellow">createPool</span><span className="yellow">(</span><span className="purple">{"{"}</span><br /></span>
